...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Blood Bank | New Donation</title>
    </head>
        ...
        <div class="wrapper">
            ...
            <div class="content">
                ...
                <div class="form-container">
                    ...
                    <div class="form-body">
                        <form action="donate_bag.php" method="post">
                            <table border="0" cellspacing="15">
                                <tr>
                                    <td class="labels">Bag ID: </td>
                                    <td></td>
                                    <td>
                                        <input type="number" name="bagID">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <table cellspacing="5">
                                            <tr>
                                                ...
                                                <td><input class="saveBtn" type="submit" name="confirmBtn" value="Confirm"></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
