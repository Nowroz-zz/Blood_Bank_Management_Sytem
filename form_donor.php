                    ...
                    <div class="form-body">
                        <form action="add_donor.php" method="post">
                            <table border="0" cellspacing="15">
                                ...
                                <tr>
                                    <td class="labels">Last Donation Date:</td>
                                    <td></td>
                                    <td><input type="date" name="lastDonDate"></td>
                                </tr>
                                <tr>
                                    <td class="labels">Number of Donations:</td>
                                    <td></td>
                                    <td><input type="number" name="numDonations"></td>
                                </tr>
                                <tr>
